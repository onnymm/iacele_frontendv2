 ...
 */ 
const useDarkMode = (): IACele.Hook.Application.Theme => {

    const [ darkMode, setDarkMode ] = useState<boolean>(
        () => {

            // Se obtiene la configuración del modo oscuro desde el dispositivo
            const storedDarkMode = localStorage.getItem(LOCAL_STORAGE.DARK_MODE) as IACele.Browser.localStorage.DarkMode;
