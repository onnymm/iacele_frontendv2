...
const Sheet: React.FC<GenericWrapperComponent> = ({
    ...
    return (
        <div className="group flex-grow bg-white dark:bg-[#1f2f3f] shadow-md pt-2 pb-4 border border-gray-500/20 rounded-lg w-full min-w-screen h-full ui-form-sheet">
